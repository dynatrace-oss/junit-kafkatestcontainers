...
@KafkaTestcontainers(
  topics = {
    @KafkaTestcontainers.Topic(
      name = AbstractSpringKafkaTest.TOPIC_1,
      partitions = AbstractSpringKafkaTest.PARTITION_COUNT
      ),
    @KafkaTestcontainers.Topic(
      name = AbstractSpringKafkaTest.TOPIC_2,
      partitions = AbstractSpringKafkaTest.PARTITION_COUNT
      )
  }
)
@SpringBootTest(classes = ConfigurationBean.class)
public class KafkaTestcontainersTest extends AbstractSpringKafkaTest {
}

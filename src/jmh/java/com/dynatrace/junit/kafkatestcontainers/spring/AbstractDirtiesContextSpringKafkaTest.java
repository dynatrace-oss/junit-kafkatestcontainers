...
import static com.dynatrace.junit.kafkatestcontainers.TestHelper.buildConsumer;
import static com.dynatrace.junit.kafkatestcontainers.TestHelper.buildProducer;
import static com.dynatrace.junit.kafkatestcontainers.TestHelper.getAdminClient;
import static org.assertj.core.api.Assertions.assertThat;
import static org.awaitility.Awaitility.await;

import com.dynatrace.junit.kafkatestcontainers.TestData;
...
abstract class AbstractDirtiesContextSpringKafkaTest {

  static final String TOPIC_1 = "TOPIC_1_SPRING_DIRTIES";
  static final String TOPIC_2 = "TOPIC_2_SPRING_DIRTIES";
  static final String TOPIC_3 = "TOPIC_3_SPRING_DIRTIES";
  ...
  @MethodSource(
    "com.dynatrace.oss.junit.kafkatestcontainers.spring.AbstractDirtiesContextSpringKafkaTest#produceAndConsumeScenarios"
  )
  @DirtiesContext
